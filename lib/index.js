 ...
 * @returns {undefined}
 */
var htmlImproved = function (filePath, fileLoader, params) {
            ...
            escape: function (template) {
                while (true) {
                    ...
                    for (var i in contents) {
                        ...
                        template = template.replace(new RegExp(BLOCK_MARK + block.id, 'g'), [block.content].join('\n'));
                    }
                }
                return template;
            }
